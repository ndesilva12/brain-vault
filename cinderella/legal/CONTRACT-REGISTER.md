...
_Master list of every agreement the structure requires. Status as of 2026-08-29. Update as documents are drafted, negotiated, and executed._
...
|---|---|---|---|---|
| 1.1 | A&R Certificate of Incorporation | Delaware / Company | ✅ Amended (Class A 1 vote / Class B 10 votes; Norman sole Class B) | *(held by Norman)* |
| 1.2 | Bylaws | Company | ❌ Confirm exists / board size = 3 | — |
| 1.3 | Seed Term Sheet | Company ↔ Investors | ✅ Drafted (clean) | `clean/Term_Sheet.md` |
| 1.4 | Stock Purchase Agreement (+ accredited questionnaire, risk factors) | Company ↔ each Investor | ✅ Drafted (clean) | `clean/Stock_Purchase_Agreement.md` |
...
| 1.9 | Restricted Stock Purchase Agreements — Ankur (166,667) · Sunjay (833,333) · Greg (166,667) | Company ↔ each holder | ✅ **Drafted 2026-09-18, values filled** | `2026-09-18-stockholders-and-rspa-generator.py` (blank template + all three) |
...
| 1.12 | Restricted Stock Purchase Agreements + 83(b) | Company ↔ each holder | ❌ Needed for every equity grant above | — |
...
| 1.15 | Loeb & Loeb engagement | Company ↔ Loeb | ✅ Engagement agreement sent 6/15/26 | — |
...
| 3.9 | Shopping / packaging agreement *(if any)* | Company ↔ producer | ⚠️ **EWS draft received 2026-08-26 — NOT SIGNED, counter issued.** Ownership + reversion are threshold items | `2026-08-27-everwonder-counter-redline-memo.md` |
...
1. **SPV Operating Agreement (2.3)** — nothing at Layer 3 can close without it.
2. **Definitive School Agreement (3.6)** — converts the signed Davidson and SJU LOIs into real rights.
3. **Shane & Jay finder agreement (1.11)** — they are actively sourcing talent with no paper in place.
4. **Capital Subscription (3.7)** — ready when a partner confirms.
5. **Long-form talent + inducement (3.2 / 3.3)** — triggered by the conditional attachment.
