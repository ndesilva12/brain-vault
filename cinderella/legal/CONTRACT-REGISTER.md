...
| 1.7 | Sunjay Mathews — Partner Agreement | Company ↔ Sunjay | ⚠️ Drafted; **not executed**. Sep 1 call: original too aggressive. Revised dated draft in Drive Legal > Seed Round (do not overwrite original). Norman sending 2026-09-03 | `2026-08-25-sunjay-partner-agreement.md` |
| 1.8 | Ankur Jain — Strategic Adviser Agreement | Company ↔ Ankur | ✅ Drafted. Norman moved to this after RSA signing 2026-09-03 | `2026-08-15-ankur-strategic-adviser-agreement.md` |
| 1.9 | Greg Kristof — Strategic Adviser Agreement | Company ↔ Greg | ✅ Drafted. Greg agreed $4k/mo Aug 30; waiting on Loeb paper before ~Sep 15 seed close | `2026-08-15-greg-strategic-adviser-agreement.md` |
...
| 1.12 | Restricted Stock Purchase Agreements + 83(b) | Company ↔ each holder | ✅ **Founder:** Aug 11 RSPA + 83(b) mailed; **acceleration signed 2026-09-03** (consent, Amd No. 1, ledger addendum). ❌ Still needed for Sunjay / Ankur / Greg / seed | `2026-09-03-founder-rsa-acceleration.md` |
