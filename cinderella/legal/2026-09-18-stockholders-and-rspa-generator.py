...
p("This Restricted Stock Purchase Agreement (this “Agreement”) is entered into as of "
  ...
  "corporation (the “Company”), and [HOLDER NAME] (“Purchaser”).")

head("1.  PURCHASE AND SALE")
p("The Company issues and sells to Purchaser, and Purchaser purchases, [______] shares of Class A "
  "Common Stock, par value $0.001 (the “Shares”), at a purchase price of $[____] per "
  "Share.", lead="1.1  Shares.  ")
...
p("Number of Shares:  ______________", after=4, justify=False)
p("Purchase price per Share:  $______________", after=4, justify=False)
p("Vesting commencement date:  ______________", after=12, justify=False)
p("Vesting schedule:", bold=True, after=6, justify=False)
p("[Insert the schedule from the holder’s separate agreement. Examples:]", italic=True,
  after=6)
p("•  Fully vested on the Effective Date; no repurchase option applies except as provided in the "
  "holder’s separate agreement.", indent=0.25, after=4)
p("•  Fifty percent (50%) vested on the Effective Date; the remainder in twenty-four (24) equal "
...
d.save(BASE + "Cinderella Corp - Restricted Stock Purchase Agreement (DRAFT).docx")
print("wrote both")
